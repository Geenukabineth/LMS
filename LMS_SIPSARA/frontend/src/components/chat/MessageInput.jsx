  ...
  return (
    <div className="flex items-center p-4 space-x-3 bg-white border-t border-gray-200">
      ...
      <input
        ...
        disabled={sending}
        className="flex-1 px-4 py-2 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-orange-600 disabled:bg-gray-100 disabled:cursor-not-allowed"
      />

      <button
        onClick={handleSendMessage}
        disabled={sending || !messageInput.trim()}
        className="flex items-center justify-center p-2 text-white transition bg-orange-600 rounded-full hover:bg-red-700 disabled:bg-gray-400 disabled:cursor-not-allowed"
        title="Send message"
      >
        {sending ? (
