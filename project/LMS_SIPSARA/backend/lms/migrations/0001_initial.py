    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('general', 'General'), ('course', 'Course'), ('instructor', 'Instructor')], default='general', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[('1 to 5', '1 To 5'), ('Ordinary level', 'Ordinary Level'), ('advanced level', 'Advanced Level'), ('extra course', 'Extra Course')], default='1 to 5', max_length=50)),
